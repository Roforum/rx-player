...
Returns the adaptations being loaded per type if a manifest is loaded. The returned object will have at most a key for each type ("video", "audio", "text" "image" and "overlay") which will each contain an array of Adaptation Objects.
...
Returns the representations being loaded per type if a manifest is loaded. The returned object will have at most a key for each type ("video", "audio", "text", "image" and "overlay") which will each contain an array of Representation Objects.
